                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="form">
                        <form action="home.php" method="post" >
                            ...
                            <input type="text" name="program_3" id="program" placeholder="Successfully Submited" disabled="disabled" required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-4">
                    <div class="form">
                        <!--<form action="#" method="post">-->
                            <button name="submit" type="submit">Search Another</button>
                        </form>
                    </div>
                </div>
            </div>
