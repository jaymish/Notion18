...
//include "sqlconnec.php";
	...
	$result_1 = mysqli_query($conn,"SELECT * FROM payment WHERE email='".$search."'");
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-md-4">
						<div class="form">
							<input type="text" name="program_2" id="program" placeholder="User not yet Registered" disabled="disabled" required>
						</div>
					</div>
				</div>
				<div class="row">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4">
                    <div class="form">
                        <form action="<?php if($search==$rows_1['email']){echo ("home.php");}else{echo("payment_php.php");}?>" method="post" >
                            <!--input type="text" name="enrollment" placeholder="Enrollment/Roll No." maxlength="12" required-->
                            <input type="text" name="program_1" id="program" placeholder="<?php if($search==$rows_1['email']){echo ("Already Paid");}else{echo("Recieved ₹".$payment." from participatent?");}?> " disabled="disabled" required>
                    </div>
                </div>
            </div>
            <div class="row">
